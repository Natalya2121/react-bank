...
const checkDisabled = (name:string) => {
  ...
  return (
    <Page>
        ...
        <span className="link__prefix">Forgot your password? <Link className="link" to="/recovery">Restore</Link></span> 

        <span className="link__prefix">Don't have an account yet? <Link className="link" to="/signup">Sign Up</Link></span> 

        <button onClick={handleSubmit} className="button page__button button--disabled" type="button">Continue</button>
